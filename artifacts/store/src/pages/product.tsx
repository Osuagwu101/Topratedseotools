...
function getIconForProduct(name: string) {
  ...
  if (n.includes("chatgpt")) return <Bot className="w-12 h-12 text-[#10A37F]" />;
  ...
  if (n.includes("stealth")) return <Shield className="w-12 h-12 text-purple-400" />;
  if (n.includes("quill") || n.includes("phrasly") || n.includes("turnitin")) return <Pencil className="w-12 h-12 text-blue-400" />;
